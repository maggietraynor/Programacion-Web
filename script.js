document.addEventListener("DOMContentLoaded", function () {
  ...
  function quitarDelCarrito(idProducto) {
    ...
    let botonesAgregarCarrito = document.querySelectorAll('.btn-agregar-carrito');
  ...
  function actualizarCarrito() {
      ...
      productosEnCarrito.forEach(function(item) {
          ...
          // Agrega un un span con las clases de Bootstrap para un botón de eliminar
          let spanEliminar = document.createElement('span');
          spanEliminar.textContent = 'Eliminar';
          spanEliminar.setAttribute('data-id-producto', item.id);
          spanEliminar.classList.add("elemento-Eliminar", "btn", "btn-primary");
  ...
  function finalizarCompra() {
    ...
    let botonesFinalizarCompra = document.querySelectorAll('.btn-finalizar-compra');
        botonesFinalizarCompra.forEach(function (boton) {
            boton.addEventListener('click', function () {
                finalizarCompra()
            });
        });
    let botonesVaciarCompra = document.querySelectorAll('.btn-vaciar-carrito');
    botonesVaciarCompra.forEach(function (boton) {
        boton.addEventListener('click', function () {
            vaciarCarrito()
        });
    });
